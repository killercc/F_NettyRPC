...
public class CuratorClient {
    ...
    public CuratorClient(String connectString, int timeout) {
        this(connectString, ZooKeeperConfig.ZK_NAMESPACE, timeout, timeout);
    }

    public CuratorClient(String connectString) {
        this(connectString, ZooKeeperConfig.ZK_NAMESPACE, ZooKeeperConfig.ZK_SESSION_TIMEOUT, ZooKeeperConfig.ZK_CONNECTION_TIMEOUT);
    }
